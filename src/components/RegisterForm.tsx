      ...
      <div className="signup-card">
        ...
        >
          ...
          <div className="signup-field-wrapper">
            ...
            <div
              className={`signup-field ${
                fieldErrors.name ? "signup-field-has-error" : ""
              }`}
            >
              <input
                ref={nameInputRef}
                ...
                className={`signup-input ${
                  fieldErrors.name ? "signup-input-error" : ""
                }`}
          ...
          <div className="signup-field-wrapper">
            ...
            <div
              className={`signup-field ${
                fieldErrors.email ? "signup-field-has-error" : ""
              }`}
            >
              <input
                id="email"
                ...
                onKeyDown={handleKeyDown}
                className={`signup-input ${
                  fieldErrors.email ? "signup-input-error" : ""
                }`}
          ...
          <div className="signup-field-wrapper">
            ...
            <div
              className={`signup-field signup-password-field ${
                fieldErrors.password ? "signup-field-has-error" : ""
              }`}
            >
              <input
                id="password"
                ...
                onKeyDown={handleKeyDown}
                className={`signup-input ${
                  fieldErrors.password ? "signup-input-error" : ""
                }`}
                aria-describedby={
              ...
              <div className="password-strength-indicator">
                <div className="strength-bar">
                  <div
                    ...
                    style={{
                      width: `${
                        (getPasswordStrength(password).score / 4) * 100
                      }%`,
