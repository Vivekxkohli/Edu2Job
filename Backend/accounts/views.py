...
from .models import User, Education, Certification, PredictionHistory, AdminLog, PredictionFeedback
...
class ProfileView(APIView):
    ...
    def get(self, request):
        ...
        # Log for debugging
        print(f"DEBUG GET: Returning education data for {user.email}:")
        print(f"  Degree: {education_data.get('degree') if education_data else 'None'}")
        print(f"  University: {education_data.get('university') if education_data else 'None'}")
...
class AdminUserListView(APIView):
    ...
    def get(self, request):
        ...
        users = User.objects.all().values(
            "id", "name", "email", "role", "date_joined"
        )
...
class AdminFlagUserView(APIView):
    ...
    def post(self, request, user_id):
        ...
        return Response({"status": "user flagged"})
